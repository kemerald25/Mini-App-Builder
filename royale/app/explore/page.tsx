...
export default function Explore() {
  ...
  const items = [
    { id: 1, title: 'Base Quest Hub', description: 'Discover curated quests, missions, and onchain drops built for Base.' },
    { id: 2, title: 'Creator Highlights', description: 'Experience the boldest apps shipping on Base every week.' },
    { id: 3, title: 'Community Radar', description: 'Signals from Farcaster and Warpcast communities across Base.' },
    { id: 4, title: 'Dev Royale Updates', description: 'Fresh templates, UI kits, and smart contract workflows.' },
  ];
      ...
      <main className="min-h-screen bg-[#0A0B0D] text-white">
        <div className="max-w-[430px] mx-auto px-4 py-8 pb-32 space-y-6">
          <header className="space-y-3 border-b border-[#1E1F25] pb-6">
            ...
            <p className="text-sm text-[#A0A0A0]">Curated drops, Base ecosystem trends, and Dev Royale highlights.</p>
          </header>
