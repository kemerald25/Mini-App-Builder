...
export default function Settings() {
  ...
  const settings = [
    { icon: Bell, title: 'Notifications', description: 'Manage alerts, quest updates, and Base drops' },
    { icon: Moon, title: 'Theme', description: 'Switch between Base night and daylight modes' },
    { icon: Shield, title: 'Privacy', description: 'Secure sessions, biometric lock, and Quick Auth' },
    { icon: Info, title: 'About Royale', description: 'Version, release notes, and support' },
  ];
      ...
      <main className={containerClasses}>
        <div className={shellClasses}>
          <header className="space-y-3 border-b border-[#1E1F25] pb-6">
            ...
            <p className="text-sm text-[#A0A0A0]">Tune your Base-native experience with precision controls.</p>
          </header>
          ...
          <section className="grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={label}
                className={`${cardClasses} flex flex-col items-start space-y-2 bg-[#101217] hover:border-[#00D4FF]/40`}
              >
          ...
          <section className={`${cardClasses} space-y-4`}>
            ...
            <button onClick={signOut} className={primaryButtonClasses}>
